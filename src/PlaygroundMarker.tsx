...
export default (props: { size: number; color: string; fee?: boolean }) => (
  <svg width={props.size} height={props.size} viewBox="0 0 100 100">
    <circle
      ...
      cy="50"
      r="48"
      fill={statusColor(props.color, "#f43f5e")}
      stroke="white"
      strokeWidth="3"
    />
    {/* Slide with tower, from svgrepo.com (playground-park-play-city-garden).
        Authored on a 64px viewBox, so it is scaled and centred into ours —
        the translate centres the artwork's own bounds, not the viewBox's. */}
    <g fill="white" transform="translate(19.6,18.8) scale(0.95)">
